...
const Page = ({ params }) => {
    ...
    return (
        <div className='pt-12'>
                    ...
                    <div className='-mt-10 ml-6 flex justify-between items-center'>
                        ...
                        <div>
                            <div className='mt-12 ml-14'>
                                <div className=' mr-2 text-[12px] bg-[#E61D64] btn border-0 rounded-full text-white font-medium px-6 h-1 min-h-10 hover:bg-[#ba4870]'>
                                    Pause now
                                </div>
            ...
            <div className='my-5 bg-white p-4 rounded-lg'>
                <TicketsByEvents id={event._id} setTickets={setTickets} tickets={tickets} />
            </div>
        </div>
    );
};
