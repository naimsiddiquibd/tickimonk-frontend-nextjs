...
const page = () => {
  return (
    <div className="max-w-6xl mx-auto p-6  shadow-sm rounded-lg pt-28 lg:pt-32">
      <h1 className="text-3xl font-bold mb-4 text-center text-gray-200">Terms and Conditions</h1>
      <p className="mb-4 text-gray-300">Welcome to Tikimonk. By using our platform to create, sell, or purchase tickets, you agree to the following terms and conditions. Please read them carefully before proceeding.</p>
      
      <section className="mb-6">
        <h2 className="text-xl font-semibold text-gray-200 mb-2">1. Introduction</h2>
        <p className="text-gray-300">These terms govern your use of our platform, including event creation, ticket sales, and ticket purchases. By creating an account or purchasing a ticket, you agree to be bound by these terms and any other policies referenced here.</p>
      </section>

      <section className="mb-6">
        <h2 className="text-xl font-semibold text-gray-200 mb-2">2. Event Creation</h2>
      ...
      <section className="mb-6">
        <h2 className="text-xl font-semibold text-gray-200 mb-2">3. Ticket Sales</h2>
        <ul className="list-disc list-inside text-gray-300">
      ...
      <section className="mb-6">
        <h2 className="text-xl font-semibold text-gray-200 mb-2">4. Ticket Purchases</h2>
        <ul className="list-disc list-inside text-gray-300">
      ...
      <section className="mb-6">
        <h2 className="text-xl font-semibold text-gray-200 mb-2">5. Platform Fees</h2>
        <p className="text-gray-300">A <strong>2% platform fee</strong> will be applied to every ticket sold, which will be automatically deducted from the sale price at the time of purchase. The platform fee is non-refundable under any circumstances.</p>
      </section>

      <section className="mb-6">
        <h2 className="text-xl font-semibold text-gray-200 mb-2">6. Cancellations and Refunds</h2>
        <ul className="list-disc list-inside text-gray-300">
      ...
      <section className="mb-6">
        <h2 className="text-xl font-semibold text-gray-200 mb-2">7. User Accounts</h2>
        <ul className="list-disc list-inside text-gray-300">
      ...
      <section className="mb-6">
        <h2 className="text-xl font-semibold text-gray-200 mb-2">8. Liability</h2>
        <ul className="list-disc list-inside text-gray-300">
      ...
      <section className="mb-6">
        <h2 className="text-xl font-semibold text-gray-200 mb-2">9. Amendments</h2>
        <p className="text-gray-300">We reserve the right to modify these terms at any time. Any changes will be effective immediately upon posting. Your continued use of the platform after changes have been made constitutes your acceptance of the revised terms.</p>
      </section>

      <section className="mb-6">
        <h2 className="text-xl font-semibold text-gray-200 mb-2">10. Governing Law</h2>
        <p className="text-gray-300">These terms shall be governed by and construed in accordance with the laws of [your country/region], without regard to conflict of law principles.</p>
      </section>
    </div>
  );
};
